...
import { formatter, formatterJson, formatterPlain } from '../formatters/index.js'
...
const diff = (file1, file2, formatName = formatter) => {
  ...
  // }
  const form = formatName(tree);
  // console.log('form:', form);
  return form;
};

// console.log('diff:', diff('fileJ1.json', 'fileJ2.json', formatter));
